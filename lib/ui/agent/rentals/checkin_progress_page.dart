...
class _CheckInProcessScreenState extends State<CheckInProcessScreen> {
  ...
  Widget _buildCurrentStep() {
    switch (currentStep) {
      case 1:
        return _stepOneVehicleInspection();
      case 2:
        return _stepTwoConfirmAgreement();
      case 3:
        return _stepThreeSuccess();
      default:
        return Container();
    }
  }
    ...
    return Column(
      ...
      children: [
        ...
        const Row(
          ...
          children: [
            Text('Starting KM', style: TextStyle(color: Colors.grey)),
            Text('12,344 KM', style: TextStyle(fontWeight: FontWeight.bold)),
          ],
        ),
        ...
        const Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text('Fuel Level', style: TextStyle(color: Colors.grey)),
          ...
          child: Column(
            children: [
              CheckboxListTile(
                ...
                subtitle: const Text(
                  'I confirm that the car is in inspected condition...',
      ...
      child: _sectionCard(
        child: Column(
          children: [
            ...
            const Text(
              'Rental has been started and is now active.',
              style: TextStyle(color: Colors.grey, fontSize: 12),
            ),
            const SizedBox(height: 20),
            Row(
