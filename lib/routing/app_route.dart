class AppRoute {
  static String splash = "/splah-screen";

  static String welcome = "/welcome";
  static String customerLogin = "/customer-login";
  static String agentLogin = "/agent-login";
  static String signupCustomer = "/customer-signup";
